using BowlingScoreOOP;
using FluentAssertions;
using Microsoft.VisualStudio.TestTools.UnitTesting;

namespace jBowlingScoreOOP.Tests
{
    [TestClass]
    public class BowlingScoreTests
    {
        ...
        public void ScoreLastFrame_Spare()
        {
            ...
            bowlingScore.Roll(2);
            bowlingScore.Roll(5);
            bowlingScore.Score().Should().Be(15);
        }
        [TestMethod]
        public void ScoreLastFrame_Strike()
        {
            BowlingScore bowlingScore = new BowlingScore();
            FillShots(bowlingScore, 0, 18);
            bowlingScore.Roll(10);
            bowlingScore.Roll(2);
            bowlingScore.Roll(5);
            bowlingScore.Score().Should().Be(24);
        }
        [TestMethod]
